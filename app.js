...
class LCG {
  ...
  // == Snake Game on a Toroidal World (Class-Based) ==
  
  class Snake {
    constructor(id, startX, startY, color, worldSize, rng) {
      this.id        = id;
  ...
  class Game {
    ...
    init() {
      ...
      for (let i = 0; i < this.snakeCount; i++) {
        ...
        this.snakes.push(new Snake(i, x, y, color, this.worldSize, this.rng));
      }
    }
